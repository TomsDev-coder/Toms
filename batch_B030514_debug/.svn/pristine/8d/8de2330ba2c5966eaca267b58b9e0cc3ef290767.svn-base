...
/**
 * DCP選定情報（ICT）情報用エンティティクラス.<br>
 * "t_dcp_select_ict"テーブルのデータをマッピングする。
 * 
 * @author IIM
 * @version 1.0
 */
@Entity
@Table(name = "t_dcp_select_ict")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@ToString
public class TDcpSelectIct implements Serializable {
